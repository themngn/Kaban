    ...
    <div class="board-header">
      ...
      <div class="header-actions">
        ...
        <button class="btn-theme-toggle" @click="toggleTheme" :title="`Switch to ${isDark ? 'light' : 'dark'} theme`">
          <svg class="theme-icon" v-if="isDark" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
          ...
          <svg class="theme-icon" v-else xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
